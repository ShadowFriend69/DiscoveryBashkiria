        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post" enctype="multipart/form-data">
                <div class="col mb-4">
                    ...
                    <input value="<?=$post['post_title']; ?>" name="post_title" type="text" class="form-control" placeholder="Название статьи" aria-label="Название статьи">
                </div>
                <div class="col">
                    <label for="editor" class="form-label">Содержимое записи</label>
                    <textarea name="post_content" id="editor" class="form-control" rows="6"><?=$post['post_content']; ?></textarea>
                </div>
